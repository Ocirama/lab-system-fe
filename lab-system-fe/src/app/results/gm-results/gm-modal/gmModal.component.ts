...
@Component({
  selector: 'app-modal',
  templateUrl: './gmModal.component.html',
  styleUrls: ['./gmModal.component.css']
})
export class GmModalComponent implements OnInit {

  constructor(
    public dialogRef: MatDialogRef<GmModalComponent>,
